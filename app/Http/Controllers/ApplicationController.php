...
class ApplicationController extends Controller
{
    ...
    public function show($id)  {
       	$job = Job::find($id);
    	return view('jobadd.application')->withJob($job);
    }
    ...
    public function store(Request $request, $id) {
    	...
    	return redirect()->route("jobsclient.show", $jobbid)->with('success','You have successfully applied to this job!');
    }
