...
class JobController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('jobadd.create')->with('categories', $categories);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard')->with('success', "Job Posting Created");
    }
    ...
    public function show($id)
    {
        ...
        return view('jobadd.show', compact('job', 'jobcount', 'result'));
    }
    ...
    public function edit($id)
    {
       ...
       return view('jobadd.edit', compact('job','categories'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/dashboard')->with('success', "You have successfully edited your job post!");
    }
