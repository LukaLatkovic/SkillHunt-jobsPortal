              ...
              <div class="col-md-4 d-flex justify-content-center counter-wrap ftco-animate">
                <div class="block-18 text-center">
                  <div class="text d-flex">
                    ...
                    <div class="desc text-left">
                      <strong class="number" data-number="46000">0</strong>
            ...
            <div class="row">
              <div class="col-md-12 nav-link-wrap">
                <div class="nav nav-pills text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                  <p class="nav-link active mr-md-1" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab"
                    aria-controls="v-pills-1" aria-selected="true">Find a Job</p>
              ...
              <div class="col-md-12 tab-wrap">
                ...
                <div class="tab-content p-4" id="v-pills-tabContent">
                  ...
                  <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel"
                    ...
                    <form action="/jobs" method="get" class="search-job">
          ...
          <div class="row no-gutters">
            <div class="col-md-2">
              <div class="top-category text-center no-border-left">
                <h3><a href="/jobs?cat=1">Information technology</h3>
                <span class="icon flaticon-contact"></span>
                <p><span class="number">{{$cat1}}</span><br /> <span>Open position</span></p>
              </div>
              </a>
            </div>
            <div class="col-md-2">
              <div class="top-category text-center">
                <h3><a href="/jobs?cat=2">Education &amp; Training</h3>
                <span class="icon flaticon-mortarboard"></span>
                <p><span class="number">{{$cat2}}</span><br /> <span>Open position</span></p>
              </div>
              </a>
            </div>
            <div class="col-md-2">
              <div class="top-category text-center">
                <h3><a href="/jobs?cat=3"> UI/UX &amp; Graphic Design</h3>
                <span class="icon flaticon-idea"></span>
                <p><span class="number">{{$cat3}}</span><br /> <span>Open position</span></p>
              </div>
              </a>
            </div>
            <div class="col-md-2">
              <div class="top-category text-center">
                <h3><a href="/jobs?cat=4">Accounting &amp; Finance</h3>
                <span class="icon flaticon-accounting"></span>
                <p><span class="number">{{$cat4}}</span><br /> <span>Open position</span></p>
              </div>
              </a>
            </div>
            <div class="col-md-2">
              <div class="top-category text-center">
                <h3><a href="/jobs?cat=5">Restaurant &amp; Food</h3>
                <span class="icon flaticon-dish"></span>
                <p><span class="number">{{$cat5}}</span><br /> <span>Open position</span></p>
              </div>
              </a>
            </div>
            <div class="col-md-2">
              <div class="top-category text-center">
                <h3><a href="/jobs?cat=6">Medical <br> care</h3>
                <span class="icon flaticon-stethoscope"></span>
                <p><span class="number">{{$cat6}}</span><br /> <span>Open position</span></p>
              </div>
              </a>
            </div>
          </div>
            ...
            <div class="job-post-item p-4 d-block d-lg-flex align-items-center">
              <div class="one-third mb-4 mb-md-0">
                ...
                <div class="job-post-item-body d-block d-md-flex">
                  <div class="mr-3"><span class="icon-layers"></span><a href="/profile/jobclientprofile/{{$job->user->id}}">{{ $job->user->name }} </a></div>
                </div>
              </div>
  ...
  <div class="container">
    <div class="row justify-content-center pb-3">
      <div class="col-md-10 heading-section heading-section-white text-center ftco-animate">
        ...
        <h2 class="mb-4">Latest Users and Companies</h2>
      </div>
    </div>
  </div>
  <div class="container">
        ...
        <div class="carousel-candidates owl-carousel">
          ...
          <div class="item">
            <a href="#" class="team text-center">
              @if(!empty($last->photo))
              <img class="rounded-circle justify-content-center img" style="height: 180px; width:180px" src="{{asset('storage/images/'.$last->photo) }}">
            @else
              <img><i class="p-0 profilepicture fas fa-user-circle fa-10x text-muted" style="height: 180px; width:180px" ></i>
            @endif
              {{-- <div class="img" style="background-image: url(images/person_1.jpg);"></div> --}}
              <h2>{{$last->user->name}}</h2>
            <span class="position"> @if($last->province !== null){{$last->province}},@endif
              @if($last->city !== null) {{$last->city}},@endif
              @if($last->country !== null){{$last->country}}@endif</span>
            </a>
          </div>
          @endif
          @endforeach
